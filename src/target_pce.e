...
include globals.e
include output.e
include specs_huc6280.e
include util.e


export procedure init_pce()
    define("PCE", 1)
    define("TGX", 1)
...
export procedure output_pce(sequence args)
    atom factor,f2,r2,smallestDiff
    integer f, songSize, pcmSize, patSize, pcmBank, column
    sequence closest
    ...
    integer tableSize = output_wla_table("xpmp_dt_mac", dutyMacros,   1, 1, #80)
...
add_target(TARGET_PCE, "pce", routine_id("init_pce"), routine_id("output_pce"))
