...
export constant TARGET_UNKNOWN = 0,
...
export enum TRG_NAME, TRG_INIT_PROC, TRG_OUTP_PROC


export constant CMD_NOTE   = #00,   -- cc+dd+eff+gg+aa+b
                CMD_REST   = #0C,   -- r
                CMD_REST2  = #0D,   -- s
                CMD_VOLUP  = #0E,   -- v+
                CMD_VOLDN  = #0F,   -- v-
...
export constant PSG_DISABLED = 0,
        PSG_ENABLED     = 1,
        YM2151_DISABLED = 0,
        YM2151_ENABLED  = 1,
        YM2413_DISABLED = 0,
...
export enum CUTOFF_VALUE, CUTOFF_TYPE

export constant CT_NORMAL = 1,
        CT_FRAMES = 2,
        CT_NEG = 3,
        CT_NEG_FRAMES = 4

export constant EFFECT_STRINGS = {"EN","EN2","EP","MP","DM","PM"}


export constant NOTES = {'c', -2, 'd', -2, 'e', 'f', -2, 'g', -2, 'a', -2, 'b', 'r', 's'}

-- Octave 1 frequencies
export constant OCTAVE1 =
{
    32.7032,    -- C
    34.6479,    -- C+ / D-
    36.7081,    -- D
...
export constant OCTAVE1_ALT_SMS = OCTAVE1 * 0.99370454545454545454545454545455


--global constant	SUPPORTED_LENGTHS = {32, 16, 8, 4, 2, 1}
--global constant ODD_LENGTHS       = {  24, 12, 6, 3}
export constant STANDARD_LENGTHS = {32, 16, 8, 4, 2, 1}
export constant EXTENDED_LENGTHS = {32, 24, 16, 12, 8, 6, 4, 3, 2, 1}

export constant DIGITS = "0123456789",
                ALPHABET = "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
                ALPHANUM = DIGITS & ALPHABET & lower(ALPHABET),
                ALPHANUM2 = ALPHANUM & '@'

export constant MONTHS = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"}
export constant WEEKDAYS = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"}

export constant CRLF = {13, 10}

export atom updateFreq

export integer target,
        verbose,
        warningsAreErrors,
        fileDataPos,
        inFile,
